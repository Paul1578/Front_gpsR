...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex h-9 w-9 items-center justify-center border-input border-y border-r " +
          "bg-input-background text-sm outline-none transition-all " +
          "first:rounded-l-md first:border-l last:rounded-r-md " +
          "data-[active=true]:z-10 data-[active=true]:ring-[3px] " +
          "data-[active=true]:border-ring data-[active=true]:ring-ring/50 " +
          "dark:bg-input/30 disabled:cursor-not-allowed aria-invalid:border-destructive " +

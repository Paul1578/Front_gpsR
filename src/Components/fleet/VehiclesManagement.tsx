...
export default function VehiclesPage({ onBack }: VehiclesManagementProps = {}) {
  ...
  const getEstadoBadge = (estado: Vehicle["estado"]) => {
    const styles: Record<Vehicle["estado"], string> = {
      disponible: "bg-green-100 text-green-700",
      en_ruta: "bg-blue-100 text-blue-700",
      mantenimiento: "bg-orange-100 text-orange-700",
    };
    const labels: Record<Vehicle["estado"], string> = {
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    estado: e.target.value as Vehicle["estado"],
                  })
                }
                className="w-full px-3 py-2 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-[#3271a4] text-sm"
              >

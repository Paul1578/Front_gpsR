...
const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: "Hay nuevas características disponibles en la plataforma",
    time: "Hace 1 hora",
    read: false,
  },
  {
    ...
    type: "warning",
    title: "Recordatorio",
    message: "Revisa tu configuración de seguridad",
    time: "Hace 2 horas",
    read: true,
  },
];
      ...
      <SheetContent className="w-full sm:max-w-md">
          ...
          {notifications.map((notification) => (
            <div
              ...
              className={`p-3 md:p-4 rounded-lg border ${
                notification.read ? "bg-gray-50" : "bg-white border-[#3271a4]/20"
              }`}
            >
              <div className="flex gap-2.5 md:gap-3">
                <div
                  className={`w-9 h-9 md:w-10 md:h-10 rounded-full ${getBackgroundColor(
                    notification.type
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between mb-1">
                    <h4 className="text-gray-900 text-sm md:text-base pr-2">
                      {notification.title}
                    </h4>
                    {!notification.read && (
                      <div className="w-2 h-2 bg-[#3271a4] rounded-full flex-shrink-0"></div>
                    )}
                  </div>
        ...
        <div className="mt-4 md:mt-6 pt-4 border-t border-gray-200">
          <button
            ...
            className="w-full py-2 text-center text-[#3271a4] hover:underline text-xs md:text-sm"
          >

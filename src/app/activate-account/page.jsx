      ...
      <div className="relative w-full max-w-5xl grid lg:grid-cols-[1.05fr_0.95fr] gap-8 items-center">
        <div className="hidden lg:block h-full rounded-3xl overflow-hidden bg-gradient-to-br from-[#1f4f73] via-[#3271a4] to-[#7cc3ff] shadow-xl border border-white/10">
          <div className="relative h-full">
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&w=1400&q=80')] bg-cover bg-center opacity-60" />
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-[#3271a4]/60 to-transparent" />
            <div className="relative h-full flex flex-col justify-between p-10 text-white">
              <div className="space-y-4">
                <p className="text-sm uppercase tracking-[0.2em] text-white/70">Bienvenida</p>
                <h2 className="text-3xl font-semibold leading-tight">Activa tu cuenta con tu propia contraseña</h2>
                <p className="text-white/80 text-sm leading-relaxed">
                  El enlace de activación usa un token de 12 caracteres. Configura tu contraseña para empezar a usar la
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-lg border border-blue-50 p-8 sm:p-10 space-y-8">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 rounded-full bg-blue-50 text-[#235075] px-4 py-2 text-xs font-semibold">
                ...
                Enlace seguro de activación
              </div>
              <h1 className="text-3xl font-semibold text-gray-900">Activa tu cuenta creando tu nueva contraseña</h1>
            ...
            <div className="space-y-3">
              ...
              {success && (
                <div className="rounded-xl border border-emerald-200 bg-emerald-50 text-emerald-700 px-4 py-3 text-sm flex items-center gap-2">
                  ...
                  Cuenta activada, ahora puedes iniciar sesión. Redirigiendo...
                </div>
              )}
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {passwordsMismatch && <div className="text-xs text-red-600">Las contraseñas no coinciden.</div>}
